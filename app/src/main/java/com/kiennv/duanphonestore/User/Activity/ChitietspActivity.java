            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        start = (float) jsonObject.getDouble("star");
                        Log.e( "onResponse: ", String.valueOf(start));
...
//                        lv.setAdapter(chatdapter);
                        ...
                        commentList.add(new Comment(id, nameUS, imageUS, status, idUS,idSP,start));
        ...
        imageSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(cmt)){
                    ...
                    Dialog dialog=new Dialog(ChitietspActivity.this);
